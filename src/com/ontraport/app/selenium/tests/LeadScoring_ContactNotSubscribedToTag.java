...
public class LeadScoring_ContactNotSubscribedToTag extends OntraportFirefoxTest{
	...
	public void testLeadScoring_ContactNotSubscribedToTag () throws Exception{
		...
		appUtilities.selectRuleDropDown (driver, "CONTACT SCORING CONDITIONS:","Select Condition", "If Contact is not subscribed to Tag");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Lead Scoring Assertion","If Contact is not subscribed to Tag:", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div[1]/div/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
		Assert.assertEquals("Tag Assertion", tagName, driver.findElement(By.xpath("(//input[@type='text'])")).getAttribute("value").trim());
		Assert.assertEquals("Tag Assertion", "11", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
		Thread.sleep(2000);
