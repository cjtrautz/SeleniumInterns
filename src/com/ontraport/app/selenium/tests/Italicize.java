...
public class Italicize extends OntraportFirefoxTest {
AppUtilities appUtilities = new AppUtilities();
	...
	public void testCreateRule() throws Exception {
		...
		Thread.sleep(3000);
		String itali = driver.findElement(By.cssSelector("textarea.cke_source.cke_enable_context_menu")).getAttribute("value").trim();
		Assert.assertTrue("Italics", itali.startsWith("<em>Selenium Test</em>"));
		
		
		//Assert.assertEquals("<em>Selenium Test</em><br />", itali);
