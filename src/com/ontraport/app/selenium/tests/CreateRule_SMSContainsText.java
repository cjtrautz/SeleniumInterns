...
public class CreateRule_SMSContainsText extends OntraportFirefoxTest{
	...
	public void testCreateRule_SMSContainsEmailAddr() throws Exception {
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "SMS Contains Text");
		Thread.sleep(3000);
		...
		Assert.assertEquals("SMS Contains", driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']/div[4]/div/div/div/div/div[2]/div[2]/div/div/div/div[2]/div[2]/div/span")).getText().trim());
