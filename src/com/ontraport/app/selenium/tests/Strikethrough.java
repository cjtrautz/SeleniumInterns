...
public class Strikethrough extends OntraportFirefoxTest {
AppUtilities appUtilities = new AppUtilities();
	...
	public void testCreateRule() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("#cke_27 > span.cke_icon")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@title='Source']")).click();
		Thread.sleep(3000);
		
		String strikthru = driver.findElement(By.cssSelector("textarea.cke_source.cke_enable_context_menu")).getAttribute("value").trim();
		
		Assert.assertTrue("strikethru", strikthru.startsWith("<strike>Selenium Test</strike>"));
