...
public class ManageGroup extends OntraportFirefoxTest {
	...
	@Test
	public void testMakeAGroupWithDropDown() throws Exception{
		driver.get(baseUrl + "/");
		String groupName = "DropDownGp";
		appUtilities.loginToApp(driver);
		Thread.sleep(3000);
		fillGroupBasicDetails (driver, groupName, "Everyone can view & Edit", "SelDropdown", "equals");
		appUtilities.selectItem(driver, "Select...", "SelOption");
		...
		driver.findElement(By.xpath("//*[@id='panelbuttonbar']/div//span[text()='Manage Groups']")).click();
		Thread.sleep(5000);
		Assert.assertEquals("SelDropdown", driver.findElement(By.xpath("(//input[@type='text'])[4]")).getAttribute("value"));
		Assert.assertEquals("equals", driver.findElement(By.xpath("(//input[@type='text'])[5]")).getAttribute("value"));
		Assert.assertEquals("SelOption", driver.findElement(By.xpath("(//input[@type='text'])[6]")).getAttribute("value"));
