...
public class Rules_SubscriptionToSequencePaused_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testRules_SubscriptionToSequencePaused_Date () throws Exception{
		...
		Thread.sleep(2000);
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "Subscription to a sequence is paused");
		Thread.sleep(3000);
		...
		Assert.assertEquals("Rule Condition Assertion","is paused", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[3]")).getText().trim());
