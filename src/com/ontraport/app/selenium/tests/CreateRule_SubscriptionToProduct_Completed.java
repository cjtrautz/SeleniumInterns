...
public class CreateRule_SubscriptionToProduct_Completed extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_SubscriptionToProduct_Completed() throws Exception {
		//driver.get(baseUrl + "/");
		//login
		WebDriver driver;
		try {
		...
		Thread.sleep(5000);
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select...", "Completed");
		Thread.sleep(5000);
		...
		Assert.assertEquals("Assertion","Completed", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
