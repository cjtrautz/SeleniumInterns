...
public class Subscript extends OntraportFirefoxTest {
AppUtilities appUtilities = new AppUtilities();
	...
	public void testCreateRule() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("#cke_28 > span.cke_icon")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@title='Source']")).click();
		Thread.sleep(3000);
		
		String subScript = driver.findElement(By.cssSelector("textarea.cke_source.cke_enable_context_menu")).getAttribute("value").trim();
		
		Assert.assertTrue("Sub Script", subScript.startsWith("<sub>Selenium Test</sub>"));
