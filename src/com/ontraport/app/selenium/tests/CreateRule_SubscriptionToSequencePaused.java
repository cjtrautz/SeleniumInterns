...
public class CreateRule_SubscriptionToSequencePaused extends OntraportFirefoxTest {
	...
	public void testCreateRule() throws Exception {
		...
		String ruleName = "SelRSubSeq"+Calendar.getInstance().getTimeInMillis();
		...
		selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Subscription to Sequence is Paused");
		Thread.sleep(2000);
