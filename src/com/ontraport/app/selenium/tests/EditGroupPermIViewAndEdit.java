...
public class EditGroupPermIViewAndEdit extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testEditGroupPermIViewAndEdit() throws InterruptedException {
		WebDriver driver;
		try {
			driver = getDriver();
		} catch (Exception e) {
        ...
        driver.findElement(By.xpath("//ul[@class='ussr-component-drilldownselect-ul']//div[.='Only I can view & edit']")).click();
		...
		Thread.sleep(1000);
        Assert.assertEquals("RuleNameAssertion","Only I can view & edit", driver.findElement(By.xpath("//div[@class='group_editor_public']/span/div/div/input")).getAttribute("value"));
        driver.findElement(By.xpath("//div[@id='ontraport_panel_action_group_edit']//span[.='Manage Groups']")).click();
        driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']//button[normalize-space(.)='<br>']")).click();
