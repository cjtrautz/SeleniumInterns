...
public class Rules_ContactNotSubscribedToSequence_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testRules_ContactNotSubscribedToSequence_Date () throws Exception{
		...
		Thread.sleep(2000);
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "If Contact is not subscribed to Sequence");
		Thread.sleep(3000);
		...
		Assert.assertEquals("Rule Condition Assertion","If Contact is not subscribed to Sequence:", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
