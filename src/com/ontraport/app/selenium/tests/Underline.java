...
public class Underline extends OntraportFirefoxTest {
AppUtilities appUtilities = new AppUtilities();
	...
	public void testCreateRule() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[@title='Underline']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@title='Source']")).click();
		Thread.sleep(3000);
		
		String underline = driver.findElement(By.cssSelector("textarea.cke_source.cke_enable_context_menu")).getAttribute("value").trim();
		Assert.assertTrue("UnderLine", underline.startsWith("<u>Selenium Test</u>"));
