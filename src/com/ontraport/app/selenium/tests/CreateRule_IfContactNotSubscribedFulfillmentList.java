...
public class CreateRule_IfContactNotSubscribedFulfillmentList extends OntraportFirefoxTest{

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_IfContactNotSubscribedFulfillmentList() throws Exception {
		driver.get(baseUrl + "/");
		//login
