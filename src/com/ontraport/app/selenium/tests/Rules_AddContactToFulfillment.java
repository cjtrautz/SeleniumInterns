...
public class Rules_AddContactToFulfillment extends OntraportFirefoxTest {
	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testRules_AddContactToFulfillment() throws Exception {
		driver.get(baseUrl + "/");
		...
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select Action...", "Add Contact to Fulfillment List");
		Thread.sleep(3000);	
		...
		Assert.assertEquals("Rule:Then Do this Assertion", "Add Contact to Fulfillment List:", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
