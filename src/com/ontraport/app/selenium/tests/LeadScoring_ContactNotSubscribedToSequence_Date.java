...
public class LeadScoring_ContactNotSubscribedToSequence_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testContactNotSubscribedToSequence_Date () throws Exception{
		...
		appUtilities.selectRuleDropDown (driver, "CONTACT SCORING CONDITIONS:","Select Condition", "If Contact is not subscribed to Sequence");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Lead Scoring Assertion","If Contact is not subscribed to Sequence:", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div[1]/div/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
