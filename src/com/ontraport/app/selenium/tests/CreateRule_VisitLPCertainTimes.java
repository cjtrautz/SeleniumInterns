...
public class CreateRule_VisitLPCertainTimes extends OntraportFirefoxTest {
	...
	public void testCreateRule_HasBeenOnSeq() throws Exception {
		...
		String ruleName = "SelVLPTms"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "Has visited a landing page a certain number of times");
		Thread.sleep(3000);
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Landing Page", "Any Landing Page");
		Thread.sleep(3000);
		...
		Assert.assertEquals("Any Landing Page", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value"));
