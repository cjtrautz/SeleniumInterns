...
public class CreateRule_WhenContactAddedToSequence extends OntraportFirefoxTest{
	...
	public void testCreateRule() throws Exception {
		...
		selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "When Contact is added to Sequence");
		Thread.sleep(2000);
