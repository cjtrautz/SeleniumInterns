...
public class CreateRule_SubscriptionToSeqPaused_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testCreateRule_SubscriptionToSeqPaused_Date () throws Exception{
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Subscription to Sequence is Paused");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","Subscription to", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[1]/div[2]/div/div[1]/div[1]/div[2]/div[2]/div[1]/span[1]")).getText());
		Assert.assertEquals("Sequence type Assertion", seqName, driver.findElement(By.xpath("(//input[@type='text'])[2]")).getAttribute("value"));
		Assert.assertEquals("Rule When it happens assertion","is paused", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[1]/div[2]/div/div[1]/div[1]/div[2]/div[2]/div[1]/span[3]")).getText());
