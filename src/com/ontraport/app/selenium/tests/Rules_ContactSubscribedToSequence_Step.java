...
public class Rules_ContactSubscribedToSequence_Step extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testRules_ContactSubscribedToSequence_Step () throws Exception{
