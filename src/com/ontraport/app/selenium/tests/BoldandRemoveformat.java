...
public class BoldandRemoveformat extends OntraportFirefoxTest {
AppUtilities appUtilities = new AppUtilities();
	...
	public void testCreateRule() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@title='Remove Format']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@title='Source']")).click();
		Thread.sleep(3000);
		
		Assert.assertEquals("Selenium Test", driver.findElement(By.cssSelector("textarea.cke_source.cke_enable_context_menu")).getAttribute("value"));
