...
public class CreateRule_CreditCardCharged extends OntraportFirefoxTest {
	...
	public void testCreateRule_CreditCardCharged() throws Exception {
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select...", "Charged");
		Thread.sleep(5000);
		...
		Assert.assertEquals("Assertion","Charged", driver.findElement(By.xpath("(//input[@type='text'])[2]")).getAttribute("value").trim());
