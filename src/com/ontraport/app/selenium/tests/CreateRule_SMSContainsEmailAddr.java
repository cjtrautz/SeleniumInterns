...
public class CreateRule_SMSContainsEmailAddr extends OntraportFirefoxTest{
	...
	public void testCreateRule_SMSContainsEmailAddr() throws Exception {
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "SMS contains an E-mail address");
		Thread.sleep(3000);
		...
		Assert.assertEquals("SMS contains an E-mail address", driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']/div[4]/div/div/div/div/div[2]/div[2]/div/div/div/div[2]/div[2]/div/span")).getText());
