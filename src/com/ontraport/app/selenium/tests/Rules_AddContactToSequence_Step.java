...
public class Rules_AddContactToSequence_Step extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testAddContactToSequence_Step () throws Exception{
		...
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select Action...", "Add Contact to Sequence");
		Thread.sleep(3000);	
		...
		Assert.assertEquals("Rule:Then Do this Assertion", "Add Contact to Sequence:", driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
