...
public class LeadScoring_ContactSubscribedToSequence extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testContactSubscribedToSequence () throws Exception{
		...
		driver.findElement(By.xpath("//div[@class='ontraport_components_rule_editor_score_editor_sentence_wrapper']//input")).sendKeys("25");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//div[@class='component-score-editor-degredation clearfix ussr-border-solid-tb ussr-texture-flat-light']//input")).sendKeys("10");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Tag Assertion", "25", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
		Assert.assertEquals("Tag Assertion", "10", driver.findElement(By.xpath("(//input[@type='text'])[4]")).getAttribute("value").trim());
		Thread.sleep(2000);
