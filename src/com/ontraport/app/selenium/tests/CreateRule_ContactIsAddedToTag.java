...
public class CreateRule_ContactIsAddedToTag  extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_ContactIsAddedToTag() throws Exception {
		driver.get(baseUrl + "/");
		//login

		appUtilities.loginToApp(driver, "tester", "passphrases are easy to break");
		String ruleName = "SelAddTag"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "When Contact is added to Tag");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","When Contact is added to Tag:", driver.findElement(By.cssSelector("span.sem-statement-text-wrapper")).getText().trim());
