...
public class CreateRule_IsSubscribedIoProduct extends OntraportFirefoxTest{
	...
	public void testCreateRule_HasBeenOnSeq() throws Exception {
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "Is subscribed to product");
		Thread.sleep(3000);
