...
public class LeadScoring_SubscriptionToSequenceUnpaused_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testSubscriptionToSequencePaused_Date () throws Exception{
