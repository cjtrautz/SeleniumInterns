...
public class Rules_NotifyWithEmail extends OntraportFirefoxTest {
	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testNotifyWithEmail() throws Exception {
		driver.get(baseUrl + "/");
		...
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select Action...", "Notify someone with an E-mail");
		Thread.sleep(3000);	
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select User", "Contact's Owner");
		Thread.sleep(3000);	
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select E-Mail", msgName);
		Thread.sleep(3000);
		...
		Assert.assertEquals("Rule:Then Do this Assertion", "Notify", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[1]")).getText().trim());
		Assert.assertEquals("Contact Name Assertion","Contact's Owner", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
		Assert.assertEquals("Rule:Then Do this Assertion", "with", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[3]")).getText().trim());
		Assert.assertEquals("Email Assertion",msgName, driver.findElement(By.xpath("(//input[@type='text'])[4]")).getAttribute("value").trim());
