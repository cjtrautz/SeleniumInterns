...
public class CreateRule_PurchasesProduct extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_PurchasesProduct() throws Exception {
		driver.get(baseUrl + "/");
		//login
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Purchases Product");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","Purchases", driver.findElement(By.cssSelector("span.sem-statement-text-wrapper")).getText().trim());
