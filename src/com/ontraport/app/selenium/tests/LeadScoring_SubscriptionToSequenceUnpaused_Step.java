...
public class LeadScoring_SubscriptionToSequenceUnpaused_Step extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testLeadScoring_SubscriptionToSequenceUnpaused_Step () throws Exception{
		...
		appUtilities.selectRuleDropDown (driver, "CONTACT SCORING CONDITIONS:","Select Condition", "Subscription to a sequence is unpaused");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Lead Scoring Assertion","is unpaused", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div[1]/div/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[3]")).getText().trim());
		Assert.assertEquals("Lead Scoring Assertion", "10", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
