...
public class EditGroupPermEveryoneViewAndEdit extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testEditGroupPermEveryoneViewAndEdit() throws InterruptedException {
		WebDriver driver;
		try {
			driver = getDriver();
		} catch (Exception e) {
        ...
        driver.findElement(By.xpath("//ul[@class='ussr-component-drilldownselect-ul']//div[.='Everyone can view & Edit']")).click();
		...
		Thread.sleep(1000);
        Assert.assertEquals("RuleNameAssertion","Everyone can view & Edit", driver.findElement(By.xpath("//div[@class='group_editor_public']/span/div/div/input")).getAttribute("value"));
        driver.findElement(By.xpath("//div[@id='ontraport_panel_action_group_edit']//span[.='Manage Groups']")).click();
        driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']//button[normalize-space(.)='<br>']")).click();
