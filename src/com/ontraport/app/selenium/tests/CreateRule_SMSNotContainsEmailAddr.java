...
public class CreateRule_SMSNotContainsEmailAddr extends OntraportFirefoxTest{

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_SMSNotContainsEmailAddr() throws Exception {
		driver.get(baseUrl + "/");
		//login

		appUtilities.loginToApp(driver, "tester", "passphrases are easy to break");
		String ruleName = "SmsNoEmil"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "SMS does not contain an E-mail address");
		Thread.sleep(3000);
		...
		Assert.assertEquals("SMS does not contain an E-mail address", driver.findElement(By.xpath("//div[@id='ussr-chrome-panel-pane']/div[4]/div/div/div/div/div[2]/div[2]/div/div/div/div[2]/div[2]/div/span")).getText().trim());
