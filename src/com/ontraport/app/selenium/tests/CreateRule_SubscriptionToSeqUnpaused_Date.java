...
public class CreateRule_SubscriptionToSeqUnpaused_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testCreateRule_SubscriptionToSeqUnpaused_Date () throws Exception{
		...
		Assert.assertEquals("Rule When it happens assertion","is unpaused", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[1]/div[2]/div/div[1]/div[1]/div[2]/div[2]/div[1]/span[3]")).getText());
