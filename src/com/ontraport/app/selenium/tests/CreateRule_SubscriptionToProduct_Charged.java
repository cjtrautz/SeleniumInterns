...
public class CreateRule_SubscriptionToProduct_Charged extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_SubscriptionToProduct_Charged() throws Exception {
		driver.get(baseUrl + "/");
		//login
		...
		Assert.assertEquals("Assertion","Charged", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value").trim());
