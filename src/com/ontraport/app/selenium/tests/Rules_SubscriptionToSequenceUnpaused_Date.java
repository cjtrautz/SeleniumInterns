...
public class Rules_SubscriptionToSequenceUnpaused_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testRules_SubscriptionToSequenceUnpaused_Date () throws Exception{
		...
		Thread.sleep(2000);
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "Subscription to a sequence is unpaused");
		Thread.sleep(3000);
		...
		Assert.assertEquals("Rule Condition Assertion","Subscription", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[1]")).getText().trim());
		...
		Assert.assertEquals("Rule Condition Assertion","is unpaused", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[3]")).getText().trim());
