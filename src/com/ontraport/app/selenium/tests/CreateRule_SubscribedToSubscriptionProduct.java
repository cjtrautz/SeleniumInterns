...
public class CreateRule_SubscribedToSubscriptionProduct extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_SubscribedToSubscriptionProduct() throws Exception {
		driver.get(baseUrl + "/");
		//login
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Is subscribed to subscription product");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","Is subscribed to", driver.findElement(By.cssSelector("span.sem-statement-text-wrapper")).getText().trim());
