...
public class CreateRule_SendsAnEMail extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_SendsAnEMail() throws Exception {
		//driver.get(baseUrl + "/");
		//login
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Sends you an E-mail");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","Sends you an E-mail", driver.findElement(By.cssSelector("span.sem-statement-text-wrapper")).getText().trim());
