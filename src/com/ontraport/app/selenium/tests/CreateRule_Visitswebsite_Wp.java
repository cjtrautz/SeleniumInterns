...
public class CreateRule_Visitswebsite_Wp  extends OntraportFirefoxTest {
	...
	public void testCreateRule_Visitswebsite_Wp() throws Exception {
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Visits website");
		Thread.sleep(2000);
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Website", "Any Website");
		Thread.sleep(5000);
		...
		Assert.assertEquals("Sequence type Assertion","Any Website", driver.findElement(By.xpath("(//input[@type='text'])[2]")).getAttribute("value").trim());
