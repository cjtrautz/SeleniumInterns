...
public class CreateRule_ClicksEMailLink extends OntraportFirefoxTest {
	...
	public void testCreateRule_Visitswebsite_Wp() throws Exception {
		...
		String ruleName = "SelRClkEm"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Clicks an E-Mail link");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Link count Assertion","0", driver.findElement(By.xpath("(//input[@type='text'])[3]")).getAttribute("value"));
