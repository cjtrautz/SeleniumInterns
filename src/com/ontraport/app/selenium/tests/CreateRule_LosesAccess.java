...
public class CreateRule_LosesAccess extends OntraportFirefoxTest {

	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testCreateRule_LosesAccess() throws Exception {
		driver.get(baseUrl + "/");
		//login

		appUtilities.loginToApp(driver, "tester", "passphrases are easy to break");
		String ruleName = "SellosAcc"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Loses access to WordPress Membership Level");
		Thread.sleep(2000);
		...
		Assert.assertEquals("Rule When it happens assertion","Loses acces to", driver.findElement(By.cssSelector("span.sem-statement-text-wrapper")).getText().trim());
