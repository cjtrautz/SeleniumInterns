...
public class CreateRule_WhenContactRemovedFromSequence extends OntraportFirefoxTest {
	...
	public void testCreateRule() throws Exception {
		...
		selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "When Contact is removed from Sequence");
		Thread.sleep(2000);
