...
public class Rules_RemoveContactFromTag extends OntraportFirefoxTest {
	AppUtilities appUtilities = new AppUtilities();

	@Test
	public void testRules_RemoveContactFromTag() throws Exception {
		driver.get(baseUrl + "/");
		...
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select Action...", "Remove Contact from Tag");
		Thread.sleep(3000);	
		...
		Assert.assertEquals("Rule:Then Do this Assertion", "Remove Contact from Tag:", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span/span[1]")).getText().trim());
