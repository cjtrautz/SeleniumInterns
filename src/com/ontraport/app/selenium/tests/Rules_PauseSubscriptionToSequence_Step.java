...
public class Rules_PauseSubscriptionToSequence_Step extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testPauseSubscriptionToSequence_Step () throws Exception{
		...
		appUtilities.selectRuleDropDown(driver, "THEN DO THIS:", "Select Action...", "Pause subscription to a sequence");
		Thread.sleep(3000);	
		...
		Assert.assertEquals("Rule:Then Do this Assertion", "Pause subscription to", driver.findElement(By.xpath("//*[@id='ussr-chrome-panel-pane']/div[4]/div[1]/div/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/span[1]")).getText().trim());
