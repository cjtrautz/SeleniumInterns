...
public class CreateRule_ContactRemovedFromSeq_Date extends OntraportFirefoxTest{
	AppUtilities appUtilities = new AppUtilities();
	
	@Test
	public void testCreateRule_ContactRemovedFromSeq_Date () throws Exception{
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "When Contact is removed from Sequence");
		Thread.sleep(2000);
