...
public class CreateRule_HasSpentAmountOnProduct extends OntraportFirefoxTest {
	...
	public void testCreateRule_HasSpentAmountOnProduct() throws Exception {
		...
		String ruleName = "SelSpntAmt"+Calendar.getInstance().getTimeInMillis();
		...
		appUtilities.selectRuleDropDown(driver, "IF THIS IS TRUE:", "Select Condition (optional)...", "Has spent a certain amount on a product");
		Thread.sleep(3000);
