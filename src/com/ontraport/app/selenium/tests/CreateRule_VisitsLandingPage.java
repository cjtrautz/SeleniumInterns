...
public class CreateRule_VisitsLandingPage  extends OntraportFirefoxTest {
	...
	public void testCreateRule_Visitswebsite_Wp() throws Exception {
		...
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Trigger...", "Visits a landing page");
		Thread.sleep(2000);
		appUtilities.selectRuleDropDown (driver, "WHEN THIS HAPPENS:","Select Landing Page", "Any Landing Page");
		Thread.sleep(5000);
		...
		Assert.assertEquals("Sequence type Assertion","Any Landing Page", driver.findElement(By.xpath("(//input[@type='text'])[2]")).getAttribute("value").trim());
