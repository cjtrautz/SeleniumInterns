...
public class CreateRule_CertainFieldIsUpdated_Checkbox extends OntraportFirefoxTest {
	...
	public void testCreateRule() throws Exception {
        ...
        driver.findElement(By.xpath("//div[@class='ussr-component-helper-field-display-rule-editor']/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/div/div/div/input")).sendKeys("Check");
		appUtilities.selectRuleDropDownWithSearch(driver, "WHEN THIS HAPPENS:", "Select Field...", "Checkbox");
		...
		Assert.assertEquals("Rule:When This Happens Assertion", "Checkbox", driver.findElement(By.xpath("(//input[@type='text'])[2]")).getAttribute("value"));
