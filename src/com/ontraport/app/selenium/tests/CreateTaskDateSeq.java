...
public class CreateTaskDateSeq extends OntraportFirefoxTest{
	...
	public void test() {
        ...
        driver.findElement(By.xpath("//span[@class='ussr-theme-sequence-task']//button[normalize-space(.)='Task']")).click();        driver.findElement(By.cssSelector("div.step_detail_radio > input[name=\"step_details_type\"]")).click();
        ...
        driver.findElement(By.cssSelector("div.ussr-component-drilldownselect-item-label.text-overflow-ellipsis")).click();
        driver.findElement(By.xpath("//div[@class='component-target-send-fields']/div[1]/div/div/div/div/div/input")).click();
        driver.findElement(By.xpath("//div[@class='component-target-send-fields']/div[1]/div/div/div/div/div/input")).clear();
