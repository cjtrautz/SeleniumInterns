...
public class CreateLeadScoring_HasBeenSubscribedToProductCertainAmountOfTime extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_HasBeenSubscribedToProductCertainAmountOfTime ()
    {
Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        ...
        contact_ScoreEdit.selectDrillDown("Has been subscribed to a product for a certain amount of time");
        contact_ScoreEdit.clickDropDownCondition();
        ...
        if(contact_ScoreEdit.verifyText("Has been subscribed to ")==null)
        {
        ...
        if(contact_ScoreEdit.verifyConditionInput("1", 2)==null)
        {
            fail("didnt Select equal to");
        }
        if(contact_ScoreEdit.verifyConditionDrillDown("Days", 3)==null)
        {
            fail("didnt Select 1");
        }
