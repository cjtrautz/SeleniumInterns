...
public class DeleteLeadScoring_IsSubscribedToFulfillment extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_IsSubscribedToFulfillment ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("If Contact is subscribed to Fulfillment List:")==null)
        {
