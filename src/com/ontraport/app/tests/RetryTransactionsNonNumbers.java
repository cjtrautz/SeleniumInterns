...
public class RetryTransactionsNonNumbers extends AbstractTest
{
    @Test
    public void testRetryTransactionsNonNumbers () throws InterruptedException
    {
        ...
        salesReport_Recharge.enterRetryCreditCardsEvery("TEST");
