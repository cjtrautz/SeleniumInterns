...
public class CreateRule_ChangeTheValueOfAFieldPrice extends AbstractTest
{
    @Test
    public void testCreateRule_ChangeTheValueOfAFieldPrice ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "change_the_value_of_price_field"));
        ...
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "change_the_value_of_price_field"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "change_the_value_of_price_field"));
        ...
        if(rule_Edit.verifyThenDropDownInputText(1, value.get("Fields", "Price_Field"))==null)
        {
