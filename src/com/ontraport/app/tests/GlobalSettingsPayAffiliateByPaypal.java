...
public class GlobalSettingsPayAffiliateByPaypal extends AbstractTest
{
    @Test
    public void testGlobalSettingsPayAffiliateByPaypal () throws InterruptedException
    {
        ...
        affiliate_Settings.selectDrillDown("Paypal");
        ...
        if(affiliate_Settings.verifyPayAffiliatesBy("Paypal")==null)
        {
