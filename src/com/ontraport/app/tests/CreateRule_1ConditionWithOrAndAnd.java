...
public class CreateRule_1ConditionWithOrAndAnd extends AbstractTest
{
    @Test
    public void testCreateRule_1ConditionWithOrAndAnd ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName("SelRule1ConditionWithOrAndAnd");
        ...
        rule_ListAll.formSearch.find("SelRule1ConditionWithOrAndAnd");
        
        //verify that rule exists
        if(rule_ListAll.verifyRule("SelRule1ConditionWithOrAndAnd")==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule("SelRule1ConditionWithOrAndAnd");
        ...
        if(rule_Edit.verifyIfDropDownInputText(7, "AND")==null)
        {
