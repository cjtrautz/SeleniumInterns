...
public class EditEmailMessagePaste extends AbstractTest
{
    @Test
    public void testEditEmailMessagePaste () throws InterruptedException
    {
        ...
        message_Edit.clickPaste();
        message_Edit.ckEditorDialogBox.enterIframePasteBody(value.get("Messages", "text_paste_body"));
        ...
        if(message_Edit.verifyBody(value.get("Messages", "text_paste_body") + value.get("Messages", "editable_email_body"))==null)
        {
