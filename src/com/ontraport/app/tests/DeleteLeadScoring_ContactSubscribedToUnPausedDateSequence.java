...
public class DeleteLeadScoring_ContactSubscribedToUnPausedDateSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactSubscribedToUnPausedDateSequence ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText(" is unpaused")==null)
        {
            fail("didnt delet If Contact is subscribed to unpaused Sequence");
        }
