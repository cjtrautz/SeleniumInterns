...
public class EditEmailMessageAlignmentLeft extends AbstractTest
{
    @Test
    public void testEditEmailMessageAlignmentLeft () throws InterruptedException
    {
        ...
        if(message_Edit.verifyLeftAligned(value.get("Messages", "editable_email_body"))==null)
        {
