...
public class CreateRule_RemoveContactFromDateSequence extends AbstractTest
{
    @Test
    public void testCreateRule_RemoveContactFromDateSequence ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "remove_contact_to_date_sequence"));
        ...
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "remove_contact_to_date_sequence"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "remove_contact_to_date_sequence"));
