...
public class CreateWordPressCancel extends AbstractTest
{
    @Test
    public void testCreateWordPressCancel () throws InterruptedException
    {
        ...
        wordPress_ListAll = wordPress_CreateType2.clickCancel();
