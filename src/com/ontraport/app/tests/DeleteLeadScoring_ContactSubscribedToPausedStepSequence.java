...
public class DeleteLeadScoring_ContactSubscribedToPausedStepSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactSubscribedToPausedStepSequence ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText(" is paused")==null)
        {
            fail("didnt delet If Contact is subscribed to paused Sequence");
        }
