...
public class CreateLeadScoring_ACheckboxFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ACheckboxFieldMeetsCriteria ()
    {
        ...
        contact_ScoreEdit.clickDropDownCondition();
        contact_ScoreEdit.enterDropDownCondition(1, value.get("Fields", "Checkbox_Field"));
        contact_ScoreEdit.selectDrillDown(value.get("Fields", "Checkbox_Field"));
        contact_ScoreEdit.clickDropDownCondition(2);
        contact_ScoreEdit.selectDrillDown("Equal To");
        contact_ScoreEdit.clickCheckBox();
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown(value.get("Fields", "Checkbox_Field"))==null)
        {
        ...
        if(contact_ScoreEdit.verifyCheckbox()==null)
        {
            fail("didnt Select date sequence");
        }
