...
public class DeleteRule_IfSubscribedToFulfillmentList extends AbstractTest
{
    @Test
    public void testDeleteRule_IfSubscribedToFulfillmentList ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleIfSubscribedToFulfillmentList");
         rule_ListAll.selectRule("SelRuleIfSubscribedToFulfillmentList");
