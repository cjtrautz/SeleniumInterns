...
public class CreateLeadScoring_ADropDownFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ADropDownFieldMeetsCriteria ()
    {
        ...
        contact_ScoreEdit.clickDropDownCondition();
        contact_ScoreEdit.enterDropDownCondition(1, value.get("Fields", "Drop_Down_Field"));
        contact_ScoreEdit.selectDrillDown(value.get("Fields", "Drop_Down_Field"));
        ...
        contact_ScoreEdit.selectDrillDown("a");
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown(value.get("Fields", "Drop_Down_Field"))==null)
        {
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown("a", 3)==null)
        {
            fail("didnt Select date sequence");
        }
