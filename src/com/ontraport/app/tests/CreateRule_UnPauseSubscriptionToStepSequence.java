...
public class CreateRule_UnPauseSubscriptionToStepSequence extends AbstractTest
{
    @Test
    public void testCreateRule_UnPauseSubscriptionToStepSequence ()
    {
        ...
        rule_Create.enterRuleName("SelRuleUnPauseSubscriptionToStepSequence");
        ...
        //verify rule exists
        if(rule_ListAll.verifyRule("SelRuleUnPauseSubscriptionToStepSequence")==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule("SelRuleUnPauseSubscriptionToStepSequence");
