...
public class DeleteLeadScoring_SMSDoesntContainText extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_SMSDoesntContainText ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("SMS Does Not Contain ")==null)
        {
