...
public class DeleteLeadScoring_HasVisitedLandingPageNumberOfTimes extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasVisitedLandingPageNumberOfTimes ()
    {
