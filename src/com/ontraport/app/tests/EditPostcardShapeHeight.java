...
public class EditPostcardShapeHeight extends AbstractTest
{
    @Test
    public void testEditPostcardShapeHeight ()
    {
        ...
        if(message_Edit.verifyHeight(50)==null)
        {
