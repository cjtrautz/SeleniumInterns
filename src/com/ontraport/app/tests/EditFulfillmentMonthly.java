...
public class EditFulfillmentMonthly extends AbstractTest
{
    @Test
    public void testEditFulfillmentMonthly ()
    {
        ...
        fulfillment_Edit.selectDrillDown("Monthly");
        fulfillment_Edit.openSchedularPaneAuxilary();
        fulfillment_Edit.selectDrillDown("5");
        ...
        if(fulfillment_Edit.verifyDay("5")==null)
        {
            fail("didnt find fulfillment schedular");
        }
