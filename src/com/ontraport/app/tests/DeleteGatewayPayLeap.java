...
public class DeleteGatewayPayLeap extends AbstractTest
{
    @Test
    public void testDeleteGatewayPayLeap ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_payleap"));
