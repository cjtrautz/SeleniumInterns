...
public class DeleteLeadScoring_ContactSubscribedToTag extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactSubscribedToTag ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("If Contact is subscribed to Tag:")==null)
        {
