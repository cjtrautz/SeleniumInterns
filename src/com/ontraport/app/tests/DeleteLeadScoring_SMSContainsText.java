...
public class DeleteLeadScoring_SMSContainsText extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_SMSContainsText ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("SMS Contains ")==null)
        {
