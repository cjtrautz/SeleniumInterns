...
public class CreateSmartFormWithAddContent extends AbstractTest
{
    @Test
    public void testCreateSmartFormWithAddContent () throws InterruptedException
    {
        ...
        smartFormFe_ListAll.formSearch.find(value.get("SmartForms", "add_content"));

        //verify Sel Tag exists
        if(smartFormFe_ListAll.verifySmartForm(value.get("SmartForms", "add_content"))==null)
        {
            fail("couldn't find smartform");
        }
        SmartFormFe_Edit smartFormFe_Edit = smartFormFe_ListAll.clickSmartform(value.get("SmartForms", "add_content"));
        if(smartFormFe_Edit.verifyAddContent()==null)
        {
