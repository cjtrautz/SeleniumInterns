...
public class DeleteEnsureStepSequenceImmedAndDelayStep extends AbstractTest
{
    @Test
    public void testDeleteEnsureStepSequenceImmedAndDelayStep () throws InterruptedException
    {
        ...
        message_ListAll.formSearch.find(value.get("Messages", "email_message_ensure_sequence"));
        ...
        message_ListAll.formSearch.find(value.get("Messages", "email_message_ensure_sequence2"));
        message_ListAll.selectAllOnPage();
        message_ListAll.drawerActions.clickDeleteMessage();
        message_ListAll.dialogBox.clickOk();
