...
public class CreateGatewayUSAePayToken extends AbstractTest
{
    @Test
    public void testCreateGatewayUSAePayToken ()
    {
        ...
        gateway_Create.enterGatewayName(value.get("Sales", "gateway_usaepay_token"));
        gateway_Create.clickGatewayTypeDropdown();
        gateway_Create.enterGatewayType("USA");
        gateway_Create.selectDrilldownOption("USAePay Token");
        ...
        gateway_ListAll.formSearch.find(value.get("Sales", "gateway_usaepay_token"));
        
        if(gateway_ListAll.verifyGatewayName(value.get("Sales", "gateway_usaepay_token"))==null)
        {
            fail("couldnt find gateway");
        }
        Gateway_Edit gateway_Edit = gateway_ListAll.clickGateway(value.get("Sales", "gateway_usaepay_token"));

        if(gateway_Edit.verifyGatewayName(value.get("Sales", "gateway_usaepay_token"))==null)
        {
