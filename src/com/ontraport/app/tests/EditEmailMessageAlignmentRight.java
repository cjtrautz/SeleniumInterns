...
public class EditEmailMessageAlignmentRight extends AbstractTest
{
    @Test
    public void testEditEmailMessageAlignmentRight () throws InterruptedException
    {
        ...
        message_Edit.clickAlignRightEmail();
        ...
        if(message_Edit.verifyRightAligned(value.get("Messages", "editable_email_body"))==null)
        {
