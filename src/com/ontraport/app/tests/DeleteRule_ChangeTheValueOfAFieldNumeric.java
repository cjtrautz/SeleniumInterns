...
public class DeleteRule_ChangeTheValueOfAFieldNumeric extends AbstractTest
{
    @Test
    public void testDeleteRule_ChangeTheValueOfAFieldNumeric ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find(value.get("Rules", "change_the_value_of_numeric_field"));
         rule_ListAll.selectRule(value.get("Rules", "change_the_value_of_numeric_field"));
