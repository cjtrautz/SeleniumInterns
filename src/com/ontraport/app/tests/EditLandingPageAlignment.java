...
public class EditLandingPageAlignment extends AbstractTest
{
    @Test
    public void testEditLandingPageAlignment ()
    {
        ...
        landingPage_Edit.clickPageAlignment();
        landingPage_Edit.selectPageAlignment("left");
        ...
        if(landingPage_Edit.verifyPageAlignment("left")==null)
        {
