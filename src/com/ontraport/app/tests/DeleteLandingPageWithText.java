...
public class DeleteLandingPageWithText extends AbstractTest
{
    @Test
    public void testDeleteLandingPageWithText ()
    {
        ...
        landingPage_ListAll.selectLandingPage(value.get("LandingPages", "Easy_Landing_Page_Text"));
