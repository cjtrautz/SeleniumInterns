...
public class DeleteRule_GetsRefundOnProduct extends AbstractTest
{
    @Test
    public void testDeleteRule_GetsRefundOnProduct ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRuleGetsRefundOnProduct");
        rule_ListAll.selectRule("SelRuleGetsRefundOnProduct");
