...
public class EditPostcardUnderline extends AbstractTest
{
    @Test
    public void testEditPostcardUnderline ()
    {
        ...
        if(message_Edit.verifyUnderlined("test text")==null)
        {
