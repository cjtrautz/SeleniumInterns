...
public class CreateRule_AFieldMeetsGivenCriteriaListSelection extends AbstractTest
{
    ...
    public void testCreateRule_AFieldMeetsGivenCriteriaListSelection ()
    {
        ...
        rule_Create.enterRuleName(value.get("Rules", "if_list_selection_meets_criteria"));
        ...
        rule_Create.selectIfDrillDownPaneOption(value.get("Fields", "list_selection_first_option"));
        rule_Create.openThenActionPane(1);
        rule_Create.selectThenDrillDownPaneOption("Recharge all declined transactions");
        rule_ListAll = rule_Create.clickSave();
        rule_ListAll.formSearch.find(value.get("Rules", "if_list_selection_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_list_selection_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_list_selection_meets_criteria"));
        ...
        if(rule_Edit.verifyIfDropDownInputText(1, value.get("Fields", "List_Field"))==null)
        {
            fail("didnt select first name");
        }
        if(rule_Edit.verifyIfDropDownInputText(3, value.get("Fields", "list_selection_first_option"))==null)
        {
