...
public class EditPostcardAlignRight extends AbstractTest
{
    @Test
    public void testEditPostcardAlignRight()
    {
        ...
        if(message_Edit.verifyAlignedRight("test text")==null)
        {
