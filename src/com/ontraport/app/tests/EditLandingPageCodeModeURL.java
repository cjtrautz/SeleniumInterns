...
public class EditLandingPageCodeModeURL extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeURL ()
    {
        ...
        if(landingPage_Edit.verifyLandingPageURLCodeMode(value.get("LandingPages", "Easy_Landing_Page_Code_Mode2") + AbstractSuite.UNIQUE)==null)
        {
