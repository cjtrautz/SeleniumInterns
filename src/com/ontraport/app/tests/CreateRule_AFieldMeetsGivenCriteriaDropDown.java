...
public class CreateRule_AFieldMeetsGivenCriteriaDropDown extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteriaDropDown ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "if_drop_down_meets_criteria"));
        ...
        rule_Create.openIfConditionPane(3);
        rule_Create.selectIfDrillDownPaneOption(value.get("Fields", "drop_down_first_option"));
        rule_Create.openThenActionPane(1);
        rule_Create.selectThenDrillDownPaneOption("Recharge all declined transactions");
        rule_ListAll = rule_Create.clickSave();
        rule_ListAll.formSearch.find(value.get("Rules", "if_drop_down_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_drop_down_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_drop_down_meets_criteria"));
        ...
        if(rule_Edit.verifyIfDropDownInputText(1, value.get("Fields", "Drop_Down_Field"))==null)
        {
