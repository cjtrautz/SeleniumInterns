...
public class DeleteGatewayQuickBooks extends AbstractTest
{
    @Test
    public void testDeleteGatewayQuickBooks ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_quickbooks"));
