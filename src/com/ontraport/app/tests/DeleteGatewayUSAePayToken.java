...
public class DeleteGatewayUSAePayToken extends AbstractTest
{
    @Test
    public void testDeleteGatewayUSAePayToken ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_usaepay_token"));
