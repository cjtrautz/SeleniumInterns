...
public class EditLandingPageCodeModeName extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeName ()
    {
        ...
        landingPage_Edit.enterName(value.get("LandingPages", "Easy_Landing_Page_Code_Mode") + " 2");
        ...
        if(landingPage_Edit.verifyName(value.get("LandingPages", "Easy_Landing_Page_Code_Mode")+ " 2")==null)
        {
