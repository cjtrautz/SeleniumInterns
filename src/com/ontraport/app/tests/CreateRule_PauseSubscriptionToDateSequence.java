...
public class CreateRule_PauseSubscriptionToDateSequence extends AbstractTest
{
    @Test
    public void testCreateRule_PauseSubscriptionToDateSequence ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "pause_subscription_to_date_sequence"));
        ...
        rule_ListAll.formSearch.find(value.get("Rules", "pause_subscription_to_date_sequence"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "pause_subscription_to_date_sequence"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "pause_subscription_to_date_sequence"));
