...
public class EditAffiliatesProgramCancel extends AbstractTest
{
    @Test
    public void testEditAffiliatesProgramCancel () throws InterruptedException
    {
        ...
        affiliateProgram_ListAll = affiliateProgram_Create.clickCancel();
        if(affiliateProgram_ListAll.verifyPage()==null)
        {
            fail("couldnt find program list all");
        }
