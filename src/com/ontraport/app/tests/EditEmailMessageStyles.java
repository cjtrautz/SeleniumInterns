...
public class EditEmailMessageStyles extends AbstractTest
{
    @Test
    public void testEditEmailMessageStyles () throws InterruptedException
    {
        ...
        message_Edit.clickStylesDropDown();
        message_Edit.clickFirstStyle(currentWindow);
        ...
        if(message_Edit.verifyStyle(value.get("Messages", "editable_email_body"))==null)
        {
