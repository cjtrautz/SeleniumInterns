...
public class EditLandingPageLetterSpacing extends AbstractTest
{
    @Test
    public void testEditLandingPageLetterSpacing ()
    {
        ...
        landingPage_Edit.clickMoveLetterSpacer(100);
        ...
        if(landingPage_Edit.verifyLetterSpacing(16.8, "test text")==null)
        {
