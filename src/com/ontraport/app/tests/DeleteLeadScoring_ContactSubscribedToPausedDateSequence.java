...
public class DeleteLeadScoring_ContactSubscribedToPausedDateSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactSubscribedToPausedDateSequence ()
    {
