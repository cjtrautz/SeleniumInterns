...
public class DeleteRule_PurchasesProduct extends AbstractTest
{
    @Test
    public void testDeleteRule_PurchasesProduct ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRulePurchasesProduct");
        rule_ListAll.selectRule("SelRulePurchasesProduct");
