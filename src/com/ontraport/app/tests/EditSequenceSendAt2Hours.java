...
public class EditSequenceSendAt2Hours extends AbstractTest
{
    @Test
    public void testEditSequenceSendAt2Hours ()
    {
        ...
        sequence_Edit.selectDrillDown("2 Hours");
        ...
        sequence_Edit.expandStep(2);
        if(sequence_Edit.verifySendAtTime("2 Hours")==null)
        {
