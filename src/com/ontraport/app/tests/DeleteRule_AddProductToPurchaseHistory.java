...
public class DeleteRule_AddProductToPurchaseHistory extends AbstractTest
{
    @Test
    public void testDeleteRule_AddProductToPurchaseHistory ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleAddProductToPurchaseHistory");
         rule_ListAll.selectRule("SelRuleAddProductToPurchaseHistory");
