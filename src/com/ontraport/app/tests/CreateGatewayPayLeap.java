...
public class CreateGatewayPayLeap extends AbstractTest
{
    @Test
    public void testCreateGatewayPayLeap ()
    {
        ...
        gateway_Create.enterGatewayName(value.get("Sales", "gateway_payleap"));
        gateway_Create.clickGatewayTypeDropdown();
        gateway_Create.selectDrilldownOption("PayLeap");
        ...
        gateway_ListAll.formSearch.find(value.get("Sales", "gateway_payleap"));
        
        if(gateway_ListAll.verifyGatewayName(value.get("Sales", "gateway_payleap"))==null)
        {
            fail("couldnt find gateway");
        }
        Gateway_Edit gateway_Edit = gateway_ListAll.clickGateway(value.get("Sales", "gateway_payleap"));

        if(gateway_Edit.verifyGatewayName(value.get("Sales", "gateway_payleap"))==null)
        {
