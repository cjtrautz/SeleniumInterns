...
public class CreateLeadScoring_ALongTextFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ALongTextFieldMeetsCriteria ()
    {
        ...
        contact_ScoreEdit.clickDropDownCondition();
        contact_ScoreEdit.enterDropDownCondition(1, value.get("Fields", "Long_Text_Field"));
        contact_ScoreEdit.selectDrillDown(value.get("Fields", "Long_Text_Field"));
        contact_ScoreEdit.clickDropDownCondition(2);
        contact_ScoreEdit.selectDrillDown("Equal To");
        contact_ScoreEdit.enterDropDownConditionTextArea("test");
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown(value.get("Fields", "Long_Text_Field"))==null)
        {
        ...
        if(contact_ScoreEdit.verifyConditionDrillDownTextarea("test")==null)
        {
            fail("didnt Select date sequence");
        }
