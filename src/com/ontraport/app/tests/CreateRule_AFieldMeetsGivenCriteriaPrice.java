...
public class CreateRule_AFieldMeetsGivenCriteriaPrice extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteriaPrice ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "if_price_meets_criteria"));
        ...
        rule_Create.openIfConditionPane(1);
        rule_Create.enterIfInputDropDown("Price", 1);
        rule_Create.selectIfDrillDownPaneOption(value.get("Fields", "Price_Field"));
        ...
        rule_ListAll.formSearch.find(value.get("Rules", "if_price_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_price_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_price_meets_criteria"));
