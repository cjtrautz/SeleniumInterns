...
public class DeleteHostedSmartForm  extends AbstractTest
{
    @Test
    public void testDeleteSmartFormWithTemplate ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        SmartFormFe_ListAll smartFormFe_ListAll = contactListAll.menuPrimary.clickSmartFormFeListAll();
        smartFormFe_ListAll.formSearch.find(value.get("SmartForms", "hosted_form"));
