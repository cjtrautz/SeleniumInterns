...
public class CreateRule_ContactIsSubscribedToTag extends AbstractTest
{
    @Test
    public void testCreateRule_ContactIsSubscribedToTag ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName("SelRuleContactIsSubscribedToTag");
        ...
        rule_ListAll.formSearch.find("SelRuleContactIsSubscribedToTag");
        
        //verify that rule exists
        if(rule_ListAll.verifyRule("SelRuleContactIsSubscribedToTag")==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule("SelRuleContactIsSubscribedToTag");
