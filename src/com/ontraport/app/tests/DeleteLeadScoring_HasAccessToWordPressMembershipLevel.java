...
public class DeleteLeadScoring_HasAccessToWordPressMembershipLevel extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasAccessToWordPressMembershipLevel ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Has access to ")==null)
        {
