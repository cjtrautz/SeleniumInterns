...
public class EditLandingPageCodeModeAlignmentCenter extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeAlignmentCenter ()
    {
        ...
        landingPage_Edit.selectPageAlignmentCodeMode("center");
        ...
        if(landingPage_Edit.verifyPageAlignmentCodeMode("center")==null)
        {
