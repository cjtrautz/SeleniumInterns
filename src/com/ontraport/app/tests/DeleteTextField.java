...
public class DeleteTextField extends AbstractTest
{
    @Test
    public void testDeleteTextField () throws InterruptedException
    {
        ...
        //verify
        if(field_Editor.verifyNotField("SelText")==null)
        {
