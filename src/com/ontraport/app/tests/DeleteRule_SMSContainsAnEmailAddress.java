...
public class DeleteRule_SMSContainsAnEmailAddress extends AbstractTest
{
    @Test
    public void testDeleteRule_ContactIsCreated ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find(value.get("Rules", "sms_contains_email"));
         rule_ListAll.selectRule(value.get("Rules", "sms_contains_email"));
