...
public class DeleteLeadScoring_HasOrderedACertainAmountOnProduct extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasOrderedACertainAmountOnProduct ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Has ordered ")==null)
        {
