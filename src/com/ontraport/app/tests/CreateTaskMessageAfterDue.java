...
public class CreateTaskMessageAfterDue extends AbstractTest
{
    @Test
    public void testCreateTaskMessageAfterDue ()
    {
        ...
        message_Edit.selectDropDownOption("After Task is Due");
        ...
        {
            fail("couldn't find After Task is Due");
        }
