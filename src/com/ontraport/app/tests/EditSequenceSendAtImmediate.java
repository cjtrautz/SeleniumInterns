...
public class EditSequenceSendAtImmediate extends AbstractTest
{
    @Test
    public void testEditSequenceSendAtImmediate ()
    {
        ...
        sequence_Edit.selectDrillDown("Immediate");
        ...
        sequence_Edit.expandStep(2);
        if(sequence_Edit.verifySendAtTime("Immediate")==null)
        {
