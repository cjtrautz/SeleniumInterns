...
public class GlobalSettingsPayAffiliateByCheck extends AbstractTest
{
    @Test
    public void testGlobalSettingsPayAffiliateByCheck () throws InterruptedException
    {
        ...
        affiliate_Settings.selectDrillDown("Check");
        ...
        if(affiliate_Settings.verifyPayAffiliatesBy("Check")==null)
        {
