...
public class DeleteRule_SubscriptionCancelled extends AbstractTest
{
    @Test
    public void testDeleteRule_SubscriptionCancelled ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRuleSubscriptionCancelled");
        rule_ListAll.selectRule("SelRuleSubscriptionCancelled");
