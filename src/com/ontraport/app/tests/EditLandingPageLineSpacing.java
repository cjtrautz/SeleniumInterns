...
public class EditLandingPageLineSpacing extends AbstractTest
{
    @Test
    public void testEditLandingPageLineSpacing ()
    {
        ...
        landingPage_Edit.clickMoveLineSpacer(100);
        ...
        if(landingPage_Edit.verifyLineSpacing(8.13333, "test text")==null)
        {
