...
public class DeleteRule_RemoveFromAllSequences extends AbstractTest
{
    @Test
    public void testDeleteRule_RemoveFromAllSequences ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleRemoveFromAllSequences");
         rule_ListAll.selectRule("SelRuleRemoveFromAllSequences");
