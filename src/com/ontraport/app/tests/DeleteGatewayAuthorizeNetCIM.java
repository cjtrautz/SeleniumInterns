...
public class DeleteGatewayAuthorizeNetCIM extends AbstractTest
{
    @Test
    public void testDeleteGatewayAuthorizeNetCIM ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_authorize_net_cim"));
