...
public class CreateRule_AFieldMeetsGivenCriteriaCheckBox extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteriaCheckBox ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "if_checkbox_meets_criteria"));
        ...
        rule_Create.openIfConditionPane(1);
        rule_Create.enterIfInputDropDown("Check", 1);
        rule_Create.selectIfDrillDownPaneOption(value.get("Fields", "Checkbox_Field"));
        rule_Create.openIfConditionPane(2);
        rule_Create.selectIfDrillDownPaneOption("Equal To");
        rule_Create.clickIfCheckBox();
        rule_Create.openThenActionPane(1);
        rule_Create.selectThenDrillDownPaneOption("Recharge all declined transactions");
        rule_ListAll = rule_Create.clickSave();
        rule_ListAll.formSearch.find(value.get("Rules", "if_checkbox_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_checkbox_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_checkbox_meets_criteria"));
        ...
        if(rule_Edit.verifyIfDropDownInputText(1, value.get("Fields", "Checkbox_Field"))==null)
        {
