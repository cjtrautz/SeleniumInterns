...
public class CreateLeadScoring_ContactSubscribedToUnPausedStepSequence extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ContactSubscribedToUnPausedStepSequence ()
    {
