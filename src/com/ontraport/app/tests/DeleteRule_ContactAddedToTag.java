...
public class DeleteRule_ContactAddedToTag extends AbstractTest
{
    @Test
    public void testDeleteRule_ContactAddedToTag ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRuleContactAddedToTag");
        rule_ListAll.selectRule("SelRuleContactAddedToTag");
