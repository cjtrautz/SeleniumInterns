...
public class CreateLeadScoring_HasAccessToWordPressMembershipLevel extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_HasAccessToWordPressMembershipLevel ()
    {
        ...
        if(contact_ScoreEdit.verifyText("Has access to ")==null)
        {
