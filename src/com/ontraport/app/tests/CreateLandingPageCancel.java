...
public class CreateLandingPageCancel extends AbstractTest
{
    @Test
    public void testCreateLandingPageCancel ()
    {
        ...
        landingPage_ListAll = landingPage_TypeSelection.clickCancel();
        
        //verify product exists
        if(landingPage_ListAll.verifyThisPage()==null)
        {
            fail("couldnt find landing page list all");
        }
