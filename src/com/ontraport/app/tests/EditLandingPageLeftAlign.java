...
public class EditLandingPageLeftAlign extends AbstractTest
{
    @Test
    public void testEditLandingPageLeftAlign ()
    {
        ...
        landingPage_Edit.clickLeftAlign();
        ...
        if(landingPage_Edit.verifyLeftAlign("test text")==null)
        {
