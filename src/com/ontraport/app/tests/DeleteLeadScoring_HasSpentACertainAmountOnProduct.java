...
public class DeleteLeadScoring_HasSpentACertainAmountOnProduct extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasSpentACertainAmountOnProduct ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Has spent ")==null)
        {
