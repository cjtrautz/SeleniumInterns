...
public class DeleteRule_HasVisitedLPNumberTimes extends AbstractTest
{
    @Test
    public void testDeleteRule_HasVisitedLPNumberTimes ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleHasVisitedLPNumberTimes");
         rule_ListAll.selectRule("SelRuleHasVisitedLPNumberTimes");
