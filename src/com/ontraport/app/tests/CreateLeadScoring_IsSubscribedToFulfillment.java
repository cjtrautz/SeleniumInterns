...
public class CreateLeadScoring_IsSubscribedToFulfillment extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_IsSubscribedToFulfillment ()
    {
        ...
        contact_ScoreEdit.selectDrillDown("If Contact is subscribed to Fulfillment List");
        contact_ScoreEdit.clickDropDownCondition();
        ...
        if(contact_ScoreEdit.verifyText("If Contact is subscribed to Fulfillment List:")==null)
        {
