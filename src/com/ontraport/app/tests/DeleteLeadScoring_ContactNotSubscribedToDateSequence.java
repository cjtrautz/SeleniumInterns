...
public class DeleteLeadScoring_ContactNotSubscribedToDateSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactNotSubscribedToDateSequence ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("If Contact is not subscribed to Sequence:")==null)
        {
