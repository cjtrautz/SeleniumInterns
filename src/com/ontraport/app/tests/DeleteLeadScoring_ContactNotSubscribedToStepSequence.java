...
public class DeleteLeadScoring_ContactNotSubscribedToStepSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactNotSubscribedToStepSequence ()
    {
