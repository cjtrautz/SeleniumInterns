...
public class DeleteLeadScoring_DoesntHaveAccessToWordPressMembershipLevel extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_DoesntHaveAccessToWordPressMembershipLevel ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Does not have access to ")==null)
        {
