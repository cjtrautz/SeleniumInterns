...
public class CreateTaskMessageAfterComplete extends AbstractTest
{
    @Test
    public void testCreateTaskMessageAfterComplete ()
    {
        ...
        message_Edit.selectDropDownOption("After Task is Complete");
        ...
        if(message_Edit.verifyWhen("After Task is Complete")==null)
        {
            fail("couldn't find After Task is Complete");
        }
