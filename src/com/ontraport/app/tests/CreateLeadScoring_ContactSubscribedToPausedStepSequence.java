...
public class CreateLeadScoring_ContactSubscribedToPausedStepSequence extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ContactSubscribedToPausedStepSequence ()
    {
        ...
        contact_ScoreEdit.selectDrillDown("Subscription to a sequence is paused");
        contact_ScoreEdit.clickDropDownCondition();
        ...
        if(contact_ScoreEdit.verifyText(" is paused")==null)
        {
            fail("didnt Select If Contact is subscribed to paused Sequence");
        }
