...
public class EditLandingPageTopWithHTML extends AbstractTest
{
    @Test
    public void testEditLandingPageTopWithHTML ()
    {
        ...
        if(landingPage_Edit.verifyTop( 50 )==null)
        {
            fail("couldnt find top");
        }
