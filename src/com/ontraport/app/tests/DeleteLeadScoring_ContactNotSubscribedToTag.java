...
public class DeleteLeadScoring_ContactNotSubscribedToTag extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactNotSubscribedToTag ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("If Contact is not subscribed to Tag:")==null)
        {
            fail("didnt delet If Contact is subscribed to tag");
        }
