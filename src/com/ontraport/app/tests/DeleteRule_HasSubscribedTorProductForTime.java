...
public class DeleteRule_HasSubscribedTorProductForTime extends AbstractTest
{
    @Test
    public void testDeleteRule_HasSubscribedTorProductForTime ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleHasSubscribedToProductForTime");
         rule_ListAll.selectRule("SelRuleHasSubscribedToProductForTime");
