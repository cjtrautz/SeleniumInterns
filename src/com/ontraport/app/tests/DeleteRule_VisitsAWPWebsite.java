...
public class DeleteRule_VisitsAWPWebsite extends AbstractTest
{
    @Test
    public void testDeleteRule_VisitsAWPWebsite ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find(value.get("Rules", "visits_wp_site"));
        rule_ListAll.selectRule(value.get("Rules", "visits_wp_site"));
