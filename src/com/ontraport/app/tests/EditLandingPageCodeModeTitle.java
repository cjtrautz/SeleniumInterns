...
public class EditLandingPageCodeModeTitle extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeTitle ()
    {
        ...
        landingPage_Edit.enterTitle(value.get("LandingPages", "Easy_Landing_Page_Code_Mode_Title") + " 2");
        ...
        if(landingPage_Edit.verifyLandingPageTitle(value.get("LandingPages", "Easy_Landing_Page_Code_Mode_Title") + " 2")==null)
        {
