...
public class DeleteLeadScoring_HasBeenSubscribedToProductCertainAmountOfTime extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasBeenSubscribedToProductCertainAmountOfTime ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Has been subscribed to ")==null)
        {
