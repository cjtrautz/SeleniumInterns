...
public class EditLandingPageURL extends AbstractTest
{
    @Test
    public void testEditLandingPageURL ()
    {
        ...
        landingPage_Edit.dialogBox.enterHostedDomainName(value.get("LandingPages", "Easy_Landing_Page_for_domain2") + AbstractSuite.UNIQUE);
        ...
        if(landingPage_Edit.verifyLandingPageURL(value.get("LandingPages", "Easy_Landing_Page_for_domain2") + AbstractSuite.UNIQUE)==null)
        {
