...
public class CreateDateSequenceFromExisting extends AbstractTest
{
    @Test
    public void testCreateDateSequenceFromExisting ()
    {
        ...
        sequence_TypeSelection.clickDateSequenceDropDown();
        Sequence_Edit sequence_Edit = sequence_TypeSelection.selectDropDown(value.get("Sequences", "date_email_sequence"));
        ...
        if(sequence_ListAll.verifySequence(value.get("Sequences", "copy_date_email_sequence"))==null)
        {
            fail("couldn't find sequence");
        }
        sequence_Edit = sequence_ListAll.clickSequence(value.get("Sequences", "copy_date_email_sequence"));
        if(sequence_Edit.verifySequenceStep("EMAIL", 1)==null)
        {
