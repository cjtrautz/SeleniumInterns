...
public class EditLandingPageCodeModeAddHTMLViaSource extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeAddHTMLViaSource ()
    {
        ...
        landingPage_Edit.clickSource();
        landingPage_Edit.enterTextArea("<p>html stuff</p>");
        ...
        if(landingPage_Edit.verifyText("html stuff")==null)
        {
