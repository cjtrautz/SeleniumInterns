...
public class EditPostcardBold extends AbstractTest
{
    @Test
    public void testEditPostcardBold ()
    {
        ...
        //message_Edit.highlightText("test text");
        ...
        if(message_Edit.verifyBold("test text")==null)
        {
