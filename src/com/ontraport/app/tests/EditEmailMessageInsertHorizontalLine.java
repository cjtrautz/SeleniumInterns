...
public class EditEmailMessageInsertHorizontalLine extends AbstractTest
{
    @Test
    public void testEditEmailMessageInsertHorizontalLine () throws InterruptedException
    {
        ...
        message_Edit.clickHorizontalLine();
        ...
        if(message_Edit.verifyLine()==null)
        {
            fail("couldn't find table");
        }
