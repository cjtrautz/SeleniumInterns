...
public class EditLandingPageRightAlign extends AbstractTest
{
    @Test
    public void testEditLandingPageRightAlign()
    {
        ...
        landingPage_Edit.clickRightAlign();
        ...
        if(landingPage_Edit.verifyRightAlign("test text")==null)
        {
            fail("couldnt find centered");
        }
