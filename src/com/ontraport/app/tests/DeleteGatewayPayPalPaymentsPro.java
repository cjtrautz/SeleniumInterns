...
public class DeleteGatewayPayPalPaymentsPro extends AbstractTest
{
    @Test
    public void testDeleteGatewayPayPalPaymentsPro ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_paypal_payments_pro"));
