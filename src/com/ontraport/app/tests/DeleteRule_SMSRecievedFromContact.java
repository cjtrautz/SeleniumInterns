...
public class DeleteRule_SMSRecievedFromContact extends AbstractTest
{
    @Test
    public void testDeleteRule_SMSRecievedFromContact ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find(value.get("Rules", "sms_recieved_by_contact"));
         rule_ListAll.selectRule(value.get("Rules", "sms_recieved_by_contact"));
