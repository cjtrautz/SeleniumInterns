...
public class CreateRule_SMSDoesNotContainText extends AbstractTest
{
    @Test
    public void testCreateRule_SMSDoesNotContainText ()
    {
        ...
        rule_ListAll.formSearch.find(value.get("Rules", "sms_does_not_contain_text"));
        
        //verify rule
        if(rule_ListAll.verifyRule(value.get("Rules", "sms_does_not_contain_text"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "sms_does_not_contain_text"));
        if(rule_Edit.verifyText("Contact is created")==null)
        {
            fail("didnt select tracked links");
        }

        if(rule_Edit.verifyText("SMS Does Not Contain ")==null)
        {
            fail("didnt select tracked links");
        }
