...
public class DeleteLeadScoring_IsNotSubscribedToFulfillment extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_IsNotSubscribedToFulfillment ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("If Contact is not subscribed to Fulfillment List:")==null)
        {
