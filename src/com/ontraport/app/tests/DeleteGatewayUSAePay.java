...
public class DeleteGatewayUSAePay extends AbstractTest
{
    @Test
    public void testDeleteGatewayUSAePay ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_usaepay"));
