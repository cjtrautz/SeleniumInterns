...
public class EditLandingPageRemoveSplitTesting extends AbstractTest
{
    @Test
    public void testEditLandingPageRemoveSplitTesting ()
    {
        ...
        landingPage_Edit.clickDeleteSplitTestingVersionB();
        ...
        if(landingPage_Edit.verifyVersionBNotPresent()==null)
        {
