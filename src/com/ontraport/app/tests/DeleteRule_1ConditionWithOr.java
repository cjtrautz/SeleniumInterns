...
public class DeleteRule_1ConditionWithOr extends AbstractTest
{
    @Test
    public void testDeleteRule_1ConditionWithOr ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRule1ConditionWithOr");
         rule_ListAll.selectRule("SelRule1ConditionWithOr");
