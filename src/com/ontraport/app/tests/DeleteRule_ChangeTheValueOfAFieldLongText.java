...
public class DeleteRule_ChangeTheValueOfAFieldLongText extends AbstractTest
{
    @Test
    public void testDeleteRule_ChangeTheValueOfAFieldLongText ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find(value.get("Rules", "change_the_value_of_long_text_field"));
         rule_ListAll.selectRule(value.get("Rules", "change_the_value_of_long_text_field"));
