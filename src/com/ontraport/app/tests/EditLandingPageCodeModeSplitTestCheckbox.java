...
public class EditLandingPageCodeModeSplitTestCheckbox extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeSplitTestCheckbox ()
    {
        ...
        landingPage_Edit.ucheckIncludePageSplitTesting();
        ...
        if(landingPage_Edit.verifySplitTestUnchecked()==null)
        {
            fail("couldnt find split test unchecked");
        }
