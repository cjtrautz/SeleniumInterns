...
public class EditEmailMessageOrderedList extends AbstractTest
{
    @Test
    public void testEditEmailMessageOrderedList () throws InterruptedException
    {
        ...
        message_Edit.clickOrderedList();
        message_Edit.clickSave();
        message_ListAll.formSearch.find(value.get("Messages", "editable_email_message"));
        message_Edit = message_ListAll.clickMessage(value.get("Messages", "editable_email_message"));
        
        if(message_Edit.verifyOrderedListIFrame(value.get("Messages", "editable_email_body"))==null) 
        {
