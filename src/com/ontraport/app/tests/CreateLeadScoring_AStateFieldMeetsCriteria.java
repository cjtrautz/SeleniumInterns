...
public class CreateLeadScoring_AStateFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_AStateFieldMeetsCriteria ()
    {
        ...
        contact_ScoreEdit.clickDropDownCondition();
        contact_ScoreEdit.enterDropDownCondition(1, value.get("Fields", "State_Field"));
        contact_ScoreEdit.selectDrillDown(value.get("Fields", "State_Field"));
        ...
        contact_ScoreEdit.selectDrillDown("Alabama");
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown(value.get("Fields", "State_Field"))==null)
        {
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown("Alabama", 3)==null)
        {
            fail("didnt Select date sequence");
        }
