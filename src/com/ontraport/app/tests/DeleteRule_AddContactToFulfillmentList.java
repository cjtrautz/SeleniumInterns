...
public class DeleteRule_AddContactToFulfillmentList extends AbstractTest
{
    @Test
    public void testDeleteRule_AddContactToFulfillmentList ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleAddContactToFulfillment");
         rule_ListAll.selectRule("SelRuleAddContactToFulfillment");
