...
public class DeleteRule_HasOpenedEmailNumberTimes extends AbstractTest
{
    @Test
    public void testDeleteRule_HasOpenedEmailNumberTimes ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleHasOpenedEmailNumberTimes");
         rule_ListAll.selectRule("SelRuleHasOpenedEmailNumberTimes");
