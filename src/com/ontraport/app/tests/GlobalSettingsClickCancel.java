...
public class GlobalSettingsClickCancel extends AbstractTest
{
    @Test
    public void testGlobalSettingsClickCancel () throws InterruptedException
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        Affiliate_Settings affiliate_Settings = contactListAll.menuPrimary.clickAffiliateSettings();
        Affiliate_ListAll affiliateProgram_ListAll = affiliate_Settings.clickCancel();
