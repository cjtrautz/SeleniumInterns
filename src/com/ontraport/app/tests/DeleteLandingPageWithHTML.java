...
public class DeleteLandingPageWithHTML extends AbstractTest
{
    @Test
    public void testDeleteLandingPageWithHTML ()
    {
        ...
        landingPage_ListAll.selectLandingPage(value.get("LandingPages", "Easy_Landing_Page_HTML"));
