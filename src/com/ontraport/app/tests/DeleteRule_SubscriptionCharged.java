...
public class DeleteRule_SubscriptionCharged extends AbstractTest
{
    @Test
    public void testDeleteRule_SubscriptionCharged ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRuleSubscriptionCharged");
        rule_ListAll.selectRule("SelRuleSubscriptionCharged");
