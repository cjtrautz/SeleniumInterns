...
public class EditEmailMessageItalicize extends AbstractTest
{
    @Test
    public void testEditEmailMessageItalicize () throws InterruptedException
    {
        ...
        message_Edit.clickItalicizeEmail();
        message_Edit.clickSave();
        message_ListAll.formSearch.find(value.get("Messages", "editable_email_message"));
        message_Edit = message_ListAll.clickMessage(value.get("Messages", "editable_email_message"));
        
        if(message_Edit.verifyItalicizeIFrame(value.get("Messages", "editable_email_body"))==null) 
        {
