...
public class DeleteRule_1ConditionWithAnd extends AbstractTest
{
    @Test
    public void testDeleteRule_1ConditionWithAnd ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRule1ConditionWithAnd");
         rule_ListAll.selectRule("SelRule1ConditionWithAnd");
