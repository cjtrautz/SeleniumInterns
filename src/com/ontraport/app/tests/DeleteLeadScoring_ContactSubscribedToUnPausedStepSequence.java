...
public class DeleteLeadScoring_ContactSubscribedToUnPausedStepSequence extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_ContactSubscribedToPausedStepSequence ()
    {
