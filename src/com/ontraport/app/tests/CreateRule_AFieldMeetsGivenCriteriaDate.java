...
public class CreateRule_AFieldMeetsGivenCriteriaDate extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteriaDate ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "if_date_meets_criteria"));
        ...
        rule_ListAll.formSearch.find(value.get("Rules", "if_date_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_date_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_date_meets_criteria"));
        ...
        if(rule_Edit.verifyIfDropDownInputText(1, value.get("Fields", "Date_Field"))==null)
        {
