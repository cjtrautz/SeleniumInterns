...
public class EditLandingPageUnderline extends AbstractTest
{
    @Test
    public void testEditLandingPageUnderline ()
    {
        ...
        landingPage_Edit.clickUnderline();
        ...
        if(landingPage_Edit.verifyUnderlined("test text")==null)
        {
