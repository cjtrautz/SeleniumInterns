...
public class EditAffilatesProgramShowCompletePurchaseHistory extends AbstractTest
{
    @Test
    public void testEditAffilatesProgramShowCompletePurchaseHistory () throws InterruptedException
    {
        ...
        affiliateProgram_Edit.clickShowPurchaseHistory();
        affiliateProgram_Edit.checkShowPurchaseHistory();
        affiliateProgram_Edit.clickSavePurchaseHistory();
