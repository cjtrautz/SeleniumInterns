...
public class CreateLeadScoring_ANumericFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ANumericFieldMeetsCriteria ()
    {
        ...
        contact_ScoreEdit.clickDropDownCondition();
        contact_ScoreEdit.enterDropDownCondition(1, value.get("Fields", "Numeric_Field"));
        contact_ScoreEdit.selectDrillDown(value.get("Fields", "Numeric_Field"));
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown(value.get("Fields", "Numeric_Field"))==null)
        {
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown("1", 4)==null)
        {
            fail("didnt Select date sequence");
        }
