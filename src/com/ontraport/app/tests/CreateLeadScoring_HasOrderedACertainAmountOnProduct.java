...
public class CreateLeadScoring_HasOrderedACertainAmountOnProduct extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_HasOrderedACertainAmountOnProduct ()
    {
        ...
        if(contact_ScoreEdit.verifyText("Has ordered ")==null)
        {
