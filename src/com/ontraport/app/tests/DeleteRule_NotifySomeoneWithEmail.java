...
public class DeleteRule_NotifySomeoneWithEmail extends AbstractTest
{
    @Test
    public void testDeleteRule_NotifySomeoneWithEmail ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleNotifySomeoneWithEmail");
         rule_ListAll.selectRule("SelRuleNotifySomeoneWithEmail");
