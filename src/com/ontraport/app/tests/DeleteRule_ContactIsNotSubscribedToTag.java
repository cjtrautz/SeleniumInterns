...
public class DeleteRule_ContactIsNotSubscribedToTag extends AbstractTest
{
    @Test
    public void testDeleteRule_ContactIsNotSubscribedToTag ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
         Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
         rule_ListAll.formSearch.find("SelRuleContactIsNotSubscribedToTag");
         rule_ListAll.selectRule("SelRuleContactIsNotSubscribedToTag");
