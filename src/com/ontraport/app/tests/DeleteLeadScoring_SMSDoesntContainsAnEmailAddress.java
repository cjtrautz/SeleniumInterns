...
public class DeleteLeadScoring_SMSDoesntContainsAnEmailAddress extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_SMSDoesntContainsAnEmailAddress ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("SMS does not contain an E-mail address")==null)
        {
