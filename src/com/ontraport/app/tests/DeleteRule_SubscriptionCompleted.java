...
public class DeleteRule_SubscriptionCompleted extends AbstractTest
{
    @Test
    public void testDeleteRule_SubscriptionCompleted ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        rule_ListAll.formSearch.find("SelRuleSubscriptionCompleted");
        rule_ListAll.selectRule("SelRuleSubscriptionCompleted");
