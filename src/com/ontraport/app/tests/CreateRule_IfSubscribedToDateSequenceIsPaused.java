...
public class CreateRule_IfSubscribedToDateSequenceIsPaused extends AbstractTest
{
    @Test
    public void testCreateRule_IfSubscribedToDateSequenceIsPaused ()
    {
        Contact_ListAll contactListAll = (Contact_ListAll) new Contact_ListAll().init();
        
        Rule_ListAll rule_ListAll = contactListAll.menuPrimary.clickRuleListAll();
        Rule_Create rule_Create = rule_ListAll.clickNewRule();
        rule_Create.enterRuleName(value.get("Rules", "if_subscription_to_date_sequence_is_paused"));
        ...
        if(rule_ListAll.verifyRule(value.get("Rules", "if_subscription_to_date_sequence_is_paused"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_subscription_to_date_sequence_is_paused"));
