...
public class EditLandingPageFormSize extends AbstractTest
{
    @Test
    public void testEditLandingPageFormSize ()
    {
        ...
        landingPage_Edit.clickFormFontSizeDropDown();
        landingPage_Edit.selectFontDropDown("32");
        ...
        if(landingPage_Edit.verifyFormSize("32")==null)
        {
            fail("couldnt find font");
        }
