...
public class EditLandingPageCodeModeInsertField extends AbstractTest
{
    @Test
    public void testEditLandingPageCodeModeInsertField ()
    {
        ...
        landingPage_Edit.clickFieldDropDown();
        landingPage_Edit.selectDrillDown("First Name");
        ...
        if(landingPage_Edit.verifyText("[First Name]test")==null)
        {
