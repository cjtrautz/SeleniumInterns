...
public class CreateRule_ACertainFieldIsUpdatedNumeric extends AbstractTest
{
    @Test
    public void testCreateRule_ACertainFieldIsUpdatedNumeric ()
    {
        ...
        rule_Create.openWhenTriggerPane(1);
        rule_Create.enterWhenInput("numer", 1);
        ...
        if(rule_ListAll.verifyRule(value.get("Rules", "when_numeric_is_updated"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "when_numeric_is_updated"));
        if(rule_Edit.verifyText(" is Updated")==null)
        {
            fail("didnt select field updated");
        }
        if(rule_Edit.verifyWhenDropDownInputText(1, value.get("Fields", "Numeric_Field"))==null)
        {
