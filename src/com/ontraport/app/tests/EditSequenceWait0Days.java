...
public class EditSequenceWait0Days extends AbstractTest
{
    @Test
    public void testEditSequenceWait0Days ()
    {
        ...
        sequence_Edit.expandStep(2);
        if(sequence_Edit.verifyWait("0")==null)
        {
