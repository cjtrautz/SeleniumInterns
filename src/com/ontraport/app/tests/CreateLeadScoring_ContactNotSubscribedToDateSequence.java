...
public class CreateLeadScoring_ContactNotSubscribedToDateSequence extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ContactNotSubscribedToDateSequence ()
    {
