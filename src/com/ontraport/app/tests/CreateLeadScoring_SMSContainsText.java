...
public class CreateLeadScoring_SMSContainsText extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_SMSContainsText ()
    {
        ...
        if(contact_ScoreEdit.verifyText("SMS Contains ")==null)
        {
