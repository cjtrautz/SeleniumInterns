...
public class EditEmailMessageInsertTable extends AbstractTest
{
    @Test
    public void testEditEmailMessageInsertTable () throws InterruptedException
    {
        ...
        if(message_Edit.verifyTable()==null)
        {
