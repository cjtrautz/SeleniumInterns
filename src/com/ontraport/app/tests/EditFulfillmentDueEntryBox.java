...
public class EditFulfillmentDueEntryBox extends AbstractTest
{
    @Test
    public void testEditFulfillmentDueEntryBox ()
    {
        ...
        fulfillment_Edit.enterDueDateBox("5");
        ...
        if(fulfillment_Edit.verifyDueDateBox("5")==null)
        {
