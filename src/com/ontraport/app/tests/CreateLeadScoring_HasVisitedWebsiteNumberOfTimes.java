...
public class CreateLeadScoring_HasVisitedWebsiteNumberOfTimes extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_HasVisitedWebsiteNumberOfTimes ()
    {
        ...
        contact_ScoreEdit.selectDrillDown("Has visited a website a certain number of times");
        contact_ScoreEdit.clickDropDownCondition();
        ...
        if(contact_ScoreEdit.verifyConditionDrillDown("Any Website")==null)
        {
