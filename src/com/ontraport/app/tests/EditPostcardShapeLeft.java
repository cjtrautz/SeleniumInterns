...
public class EditPostcardShapeLeft extends AbstractTest
{
    @Test
    public void testEditPostcardShapeLeft ()
    {
        ...
        if(message_Edit.verifyLeft(300)==null)
        {
