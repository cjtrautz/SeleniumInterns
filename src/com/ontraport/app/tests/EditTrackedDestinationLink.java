...
public class EditTrackedDestinationLink extends AbstractTest
{
    @Test
    public void testEditTrackedDestinationLink () throws InterruptedException
    {
        ...
        trackingLinks_Edit.clickDestinationURL();
        trackingLinks_Edit.enterDestinationURL(value.get("Tracking", "tracking_link_url2"));
        trackingLinks_Edit.clickSaveDestinationURL();
        ...
        trackingLinks_Edit = trackingLinks_ListAll.clickTrackedLink(value.get("Tracking", "tracking_link_name"));
        if(trackingLinks_Edit.verifyDestinationLink(value.get("Tracking", "tracking_link_url2"))==null)
        {
