...
public class EditLandingPageFont extends AbstractTest
{
    @Test
    public void testEditLandingPageFont ()
    {
        ...
        landingPage_Edit.clickFontDropDown();
        landingPage_Edit.selectFontDropDown("Impact");
        ...
        if(landingPage_Edit.verifyFont("test text", "Impact")==null)
        {
