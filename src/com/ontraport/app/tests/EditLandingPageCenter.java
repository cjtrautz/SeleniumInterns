...
public class EditLandingPageCenter extends AbstractTest
{
    @Test
    public void testEditLandingPageCenter ()
    {
        ...
        if(landingPage_Edit.verifyCenter("test text")==null)
        {
