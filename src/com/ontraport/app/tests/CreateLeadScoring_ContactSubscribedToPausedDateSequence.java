...
public class CreateLeadScoring_ContactSubscribedToPausedDateSequence extends AbstractTest
{
    @Test
    public void testCreateLeadScoring_ContactSubscribedToPausedDateSequence ()
    {
