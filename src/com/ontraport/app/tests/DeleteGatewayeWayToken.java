...
public class DeleteGatewayeWayToken extends AbstractTest
{
    @Test
    public void testDeleteGatewayeWayToken ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_eway_token"));
