...
public class DeleteLeadScoring_AListSelectionFieldMeetsCriteria extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_AListSelectionFieldMeetsCriteria ()
    {
