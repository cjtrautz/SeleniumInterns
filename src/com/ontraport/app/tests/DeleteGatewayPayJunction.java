...
public class DeleteGatewayPayJunction extends AbstractTest
{
    @Test
    public void testDeleteGatewayPayJunction ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_payjunction"));
