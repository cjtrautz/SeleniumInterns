...
public class EditPostcardShapeWidth extends AbstractTest
{
    @Test
    public void testEditPostcardShapeWidth ()
    {
        ...
        if(message_Edit.verifyWidth(50)==null)
        {
