...
public class EditEmailMessageInsertSpecialCharacter extends AbstractTest
{
    @Test
    public void testEditEmailMessageInsertSpecialCharacter () throws InterruptedException
    {
        ...
        message_Edit.clickInsertSpecialCharacter();
        message_Edit.ckEditorDialogBox.clickAlmostEqualTo();
        ...
        if(message_Edit.verifySpecialCharacterAlmostEqual()==null)
        {
