...
public class DeleteLeadScoring_HasVisitedWebsiteNumberOfTimes extends AbstractTest
{
    @Test
    public void testDeleteLeadScoring_HasClickedTrackedLinkNumberOfTimes ()
    {
        ...
        if(contact_ScoreEdit.verifyNoText("Has visited ")==null)
        {
            fail("didnt delet Has visited ");
        }
