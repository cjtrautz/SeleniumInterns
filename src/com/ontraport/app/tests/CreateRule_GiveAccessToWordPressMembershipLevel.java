...
public class CreateRule_GiveAccessToWordPressMembershipLevel extends AbstractTest
{
    @Test
    public void testCreateRule_GiveAccessToWordPressMembershipLevel ()
    {
        ...
        rule_ListAll.formSearch.find(value.get("Rules", "give_access_to_wordpress_membership_level"));
        
        //verify rule
        if(rule_ListAll.verifyRule(value.get("Rules", "give_access_to_wordpress_membership_level"))==null)
        {
