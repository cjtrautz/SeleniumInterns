...
public class DeleteGatewayPayflowPro extends AbstractTest
{
    @Test
    public void testDeleteGatewayPayflowPro ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_payflow_pro"));
