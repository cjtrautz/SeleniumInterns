...
public class DeleteGatewayNetworkMerchantsInc extends AbstractTest
{
    @Test
    public void testDeleteGatewayNetworkMerchantsInc ()
    {
        ...
        gateway_ListAll.selectGateway(value.get("Sales", "gateway_network_merchants_inc"));
