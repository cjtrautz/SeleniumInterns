...
public class CreateRule_AFieldMeetsGivenCriteriaState extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteriaState ()
    {
        ...
        rule_Create.enterRuleName(value.get("Rules", "if_state_meets_criteria"));
        ...
        rule_Create.selectIfDrillDownPaneOption("California");
        rule_Create.openThenActionPane(1);
        rule_Create.selectThenDrillDownPaneOption("Recharge all declined transactions");
        rule_ListAll = rule_Create.clickSave();
        rule_ListAll.formSearch.find(value.get("Rules", "if_state_meets_criteria"));
        
        //verify rule exists
        if(rule_ListAll.verifyRule(value.get("Rules", "if_state_meets_criteria"))==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule(value.get("Rules", "if_state_meets_criteria"));
        ...
        if(rule_Edit.verifyIfDropDownInputText(1, value.get("Fields", "State_Field"))==null)
        {
