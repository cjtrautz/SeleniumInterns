...
public class CreateRule_AFieldMeetsGivenCriteria extends AbstractTest
{
    @Test
    public void testCreateRule_AFieldMeetsGivenCriteria ()
    {
        ...
        rule_Create.enterRuleName("SelRuleFieldMeetsCriteria");
        ...
        rule_Create.openIfConditionPane(1);
        rule_Create.selectIfDrillDownPaneOption("First Name");
        ...
        rule_ListAll.formSearch.find("SelRuleFieldMeetsCriteria");
        
        //verify rule exists
        if(rule_ListAll.verifyRule("SelRuleFieldMeetsCriteria")==null)
        {
            fail("couldnt find created rule");
        }
        Rule_Edit rule_Edit = rule_ListAll.clickRule("SelRuleFieldMeetsCriteria");
