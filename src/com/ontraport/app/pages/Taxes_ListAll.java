...
public class Taxes_ListAll extends AbstractPage
{    
    ...
    public Taxes_ListAll selectAllOnPage ()
    {
    ...
    public Taxes_ListAll verifyNoTax ()
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public Taxes_ListAll verifyTaxItem (String string)
    {
        AbstractPart.waitForAjax(driver, 20);
        wait.until(ExpectedConditions.visibilityOf(uiCollectionBody));
        try
