...
public class Contact_ListAll extends AbstractPage
{
    ...
    public Contact_ListAll verifyPage ()
    {
        ...
        try
        {
            wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[contains(concat(' ', normalize-space(@class), ' '),' ussr-chrome-panel-pane-header-title ')]/span[text()=\"No contacts yet... let's create some!\" or text()='Contacts']"))));
