...
public class MessageTemplate_CreateType1 extends AbstractPage
{
    ...
    public MessageTemplate_CreateType1 enterMessageName ( String name )
    {
    ...
    public MessageTemplate_CreateType1 enterSendOutName ( String name )
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public MessageTemplate_CreateType1 enterReplyToEmail ( String name )
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public MessageTemplate_CreateType1 openMailFromPane ()
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public MessageTemplate_CreateType1 selectMailFrom ( int i )
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public MessageTemplate_CreateType1 enterSubject ( String subject )
    {
        AbstractPart.waitForAjax(driver, 20);
    ...
    public MessageTemplate_CreateType1 enterMessageBody ( String string )
    {
        AbstractPart.waitForAjax(driver, 20);
