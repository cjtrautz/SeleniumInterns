...
{   
    ...
    com.ontraport.app.tests.AddTaxToOrderForm.class,
    com.ontraport.app.tests.RemoveTaxItemFromForm.class,
    com.ontraport.app.tests.DeleteTaxItemCreatedFromForm.class,
  ...
  //uses CreateRuleStepSequence sequence and uses CreateSplitTestMessages messages
    ...
    com.ontraport.app.tests.AddTagToGroupSubset.class
